# Keyboard Passthrough — Waveshare RP2350-USB-A

A USB keyboard pass-through device built on the Waveshare RP2350-USB-A and CircuitPython. It sits between a physical keyboard and a host PC, intercepts keystrokes, executes custom actions, and transparently forwards all keys to the PC.
